...
import { findDOMNode } from 'dulcet-dom';
...
class CSSTransitionGroupChild extends Dulcet.Component {
  ...
  render() {
    ...
    return Dulcet.cloneElement(Dulcet.Children.only(this.props.children), props);
  }
}
